...
class App(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.canvas.bind("<Configure>", self.update_frame_size)
    ...
    def show_page(self, cont):
        """Show the frame with the specified index."""
    ...
    # NEW METHOD: Add this method to reset the application state
    def reset_application(self):
        """
        Reset all controller variables to their initial state and navigate to StartFrame.
        This clears all user selections (e.g., username, password, task) so the application
        starts fresh, as if newly launched. Called by RequestFrame's 'Start New Operation' button.
        """
        # Clear user-related fields to ensure UserFrame and PasswordFrame start blank
        self.selected_user_id = None  # Clears username selection
        ...
        self.old_location_id = None
        self.selected_location_id = None
        # Clear emotion and picture fields
        self.selected_emotion = None
        self.selected_picture = None
        ...
        self.selected_item_type = None
        self.input_battery_desc = None
        # Navigate to StartFrame (frame_index=0) to restart the workflow
        self.show_page(0)
