...
class RequestFrame(tk.Frame):
    ...
    def __init__(self, master, controller):
        ...
        self.report_text = tk.Text(content, height=10, wrap=tk.WORD, font=("Roboto", 11))
    ...
    def load_report(self):
        ...
        # Compose report
        if self.controller.input_battery_desc:
            final_report = (f"{self.employee} added {self.battery_desc} to the database.\n"
                            f"Serial Number: {self.serial_num}\nPart Number: {self.part_num}\nItem Type: {self.item_type}\n"
            ...
            if self.work_type_id == "1":
                final_report = f"{self.employee} found {self.battery_desc}.\nNow {self.employee} is {self.emotion}, feeling that the task was {self.adjective}."
            elif self.work_type_id == "2":
                final_report = (f"{self.employee} received {self.battery_desc} from {self.client_status} {self.client}.\n"
                ...
                final_report = f"{self.employee} shipped {self.battery_desc} to {self.client_status} {self.client}.\nNow {self.employee} is {self.emotion}, feeling that the task was {self.adjective}."
            elif self.work_type_id == "4":
                final_report = f"{self.employee} moved {self.battery_desc} from {self.old_location} to {self.new_location}.\nNow {self.employee} is {self.emotion}, feeling that the task was {self.adjective}."
            elif self.work_type_id == "20":
                final_report = f"{self.employee} took a picture of {self.battery_desc}.\nNow {self.employee} is {self.emotion}, feeling that the task was {self.adjective}."
    ...
    def submit_request(self):
        # Implement your database insertions
        pass
